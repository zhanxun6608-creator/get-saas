...
async function seed() {
  ...
  const toolData = [
    {
      ...
      name: 'Apify',
      slug: 'apify',
      description: 'Full-stack web scraping and automation platform with 1,500+ pre-built extractors and AI agents.',
      longDescription: 'Apify is the leading web scraping and automation platform trusted by 10,000+ developers and businesses. It offers 1,500+ pre-built Actors (scrapers) for Google, Amazon, LinkedIn, Twitter, and more — plus AI browser agents that can navigate any website, extract structured data, and handle CAPTCHAs, proxies, and anti-bot measures automatically. Ideal for lead generation, competitor monitoring, and data extraction at scale.',
      category: 'browser_agent',
      websiteUrl: 'https://apify.com',
      affiliateUrl: '#',
      pricing: 'Freemium',
      bestFor: ['web-scraping', 'lead-generation', 'competitor-research'],
      pros: ['1,500+ pre-built extractors', 'Built-in proxy & CAPTCHA handling', 'Scales to millions of pages', 'AI agent mode for complex sites'],
      cons: ['Credit costs add up at scale', 'Advanced features need coding'],
    ...
    },
    {
      ...
      name: 'Jasper',
      slug: 'jasper',
      description: 'AI writing platform for SEO content, blog posts, and marketing copy — trained on top-performing content.',
      longDescription: 'Jasper is an enterprise-grade AI writing platform purpose-built for marketing teams. Unlike generic chatbots, Jasper is trained on high-performing marketing content and includes built-in SEO mode, brand voice customization, and campaign workflows. It can generate blog posts, social media content, email sequences, ad copy, and product descriptions — all optimized for conversions and search rankings.',
      category: 'writing_agent',
      websiteUrl: 'https://jasper.ai',
      affiliateUrl: '#',
      pricing: 'Paid',
      bestFor: ['seo-content', 'market-research'],
      pros: ['Marketing-trained AI model', 'Built-in SEO & brand voice', 'Campaign workflow automation', 'Team collaboration features'],
      cons: ['Higher price point', 'Overkill for casual use'],
    ...
    },
    {
      ...
      name: 'Octoparse',
      slug: 'octoparse',
      description: 'No-code web scraping tool with point-and-click interface and built-in AI data extraction.',
      longDescription: 'Octoparse is a no-code web scraping platform that lets anyone extract data from websites without writing a single line of code. Its visual point-and-click interface makes it easy to select data fields, while AI-powered auto-detection handles pagination, infinite scroll, and dynamic content. Supports scheduled scraping, cloud execution, and exports to Excel, CSV, JSON, or direct database integration.',
      category: 'browser_agent',
      websiteUrl: 'https://octoparse.com',
      affiliateUrl: '#',
      pricing: 'Freemium',
      bestFor: ['web-scraping', 'lead-generation', 'competitor-research'],
      pros: ['True no-code interface', 'AI auto-detects data patterns', 'Cloud scheduling & execution', 'Handles dynamic content'],
      cons: ['Limited API access on free plan', 'Slower than code-based scrapers'],
      automationLevel: 'high',
      easeOfUse: 'beginner',
      featuredRank: 3,
      sponsorStatus: null,
    },
    {
      ...
      name: 'Surfer SEO',
      slug: 'surferseo',
      description: 'AI-powered SEO optimization platform for content planning, writing, and ranking analysis.',
      longDescription: 'Surfer SEO is a comprehensive SEO platform that uses AI to analyze top-ranking pages and guide your content creation. Its Content Editor provides real-time optimization suggestions as you write — keyword density, structure, word count, and NLP entities. The AI writing assistant can generate full article drafts optimized for specific keywords, while the Audit tool identifies gaps in existing content.',
      category: 'seo_agent',
      websiteUrl: 'https://surferseo.com',
      affiliateUrl: '#',
      pricing: 'Paid',
      bestFor: ['seo-content', 'competitor-research'],
      pros: ['Real-time content scoring', 'SERP analysis & keyword clustering', 'AI content generation', 'Content audit & gap analysis'],
      cons: ['Paid plans only', 'Best when paired with a writer'],
      automationLevel: 'medium',
      easeOfUse: 'beginner',
      featuredRank: null,
      sponsorStatus: null,
    },
    {
      ...
      name: 'Lusha',
      slug: 'lusha',
      description: 'B2B contact data platform for finding and enriching prospect emails, phone numbers, and company data.',
      longDescription: 'Lusha is a B2B sales intelligence platform that provides accurate contact and company data for prospecting. Its browser extension reveals email addresses and direct phone numbers on LinkedIn, Salesforce, and company websites. With API access and CRM integrations, Lusha enables automated lead enrichment at scale — making it essential for outbound sales and lead generation workflows.',
      category: 'data_agent',
      websiteUrl: 'https://lusha.com',
      affiliateUrl: '#',
      pricing: 'Freemium',
      bestFor: ['lead-generation', 'market-research'],
      pros: ['One-click LinkedIn enrichment', 'High data accuracy rates', 'CRM & API integrations', 'Generous free tier'],
      cons: ['B2B only, no B2C data', 'Credit limits on free plan'],
      automationLevel: 'medium',
      easeOfUse: 'beginner',
      featuredRank: null,
      sponsorStatus: null,
  ...
  const workflowData = [
    {
      ...
      toolsIncluded: ['Apify', 'Octoparse', 'Perplexity AI'],
      steps: [
        'Define competitor universe and monitoring scope',
        'Configure automated weekly scrapes with Apify or Octoparse',
    ...
    },
    {
      ...
      toolsIncluded: ['Apify', 'Lusha'],
      steps: [
        'Define ideal customer profile and targeting criteria',
        'Configure Apify for multi-platform prospect discovery',
        'Set up Lusha for automated contact data enrichment',
    ...
    },
    {
      ...
      toolsIncluded: ['Jasper', 'Surfer SEO'],
      steps: [
        'Set up keyword discovery and prioritization pipeline with Surfer SEO',
        'Configure SERP analysis and content gap identification',
        'Build automated content brief and outline generation',
        'Create AI writing workflows in Jasper for first drafts',
  ...
  const taskToolMap: Record<string, string[]> = {
    'competitor-research': ['apify', 'octoparse', 'perplexity', 'openai-deep-research', 'surferseo'],
    'lead-generation': ['apify', 'octoparse', 'lusha'],
    'seo-content': ['jasper', 'surferseo', 'perplexity'],
    'web-scraping': ['apify', 'octoparse'],
    'market-research': ['perplexity', 'openai-deep-research', 'apify'],
  }
